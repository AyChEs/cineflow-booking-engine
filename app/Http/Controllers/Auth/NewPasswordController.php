...
class NewPasswordController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        // No lang/ files in this project, so map the broker's status constants to
        // plain English directly instead of __() (which would just echo the raw key).
        ...
        $message = match ($status) {
            ...
            default => 'Something went wrong resetting your password.',
        };
